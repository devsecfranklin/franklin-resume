...
variable "primary_panorama_name" {
  type    = string
  default = "panorama-primary"
}

variable "secondary_panorama_name" {
  type    = string
  default = "panorama-secondary"
}
...
variable "primary_panorama_private_ip_address" {
...
variable "secondary_panorama_private_ip_address" {
  description = "Optional static private IP address of Panorama, for example 192.168.11.22. If empty, Panorama uses dynamic assignment."
  type        = string
  default     = null
}
...
variable "vnet_name" {
  default = "damian_is_working_sunday"
  type    = string
}

# Palo Alto Networks Transit VNet Common
...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_bootstrap"></a> [bootstrap](#module\_bootstrap) | github.com/PaloAltoNetworks/terraform-azurerm-vmseries-modules//modules/bootstrap | v0.2.0 |
| <a name="module_common_vmseries"></a> [common\_vmseries](#module\_common\_vmseries) | github.com/PaloAltoNetworks/terraform-azurerm-vmseries-modules//modules/vmseries | v0.2.0 |
| <a name="module_inbound_lb"></a> [inbound\_lb](#module\_inbound\_lb) | github.com/PaloAltoNetworks/terraform-azurerm-vmseries-modules//modules/loadbalancer | v0.2.0 |
| <a name="module_outbound_lb"></a> [outbound\_lb](#module\_outbound\_lb) | github.com/PaloAltoNetworks/terraform-azurerm-vmseries-modules//modules/loadbalancer | v0.2.0 |
...
| <a name="input_name_prefix"></a> [name\_prefix](#input\_name\_prefix) | A prefix for all the names of the created Azure objects. It can end with a dash `-` character, if your naming convention prefers such separator. | `string` | `""` | no |
...
| <a name="input_tags"></a> [tags](#input\_tags) | Map of tags to be associated with the virtual machines, their interfaces and public IP addresses. | `map(string)` | `{}` | no |

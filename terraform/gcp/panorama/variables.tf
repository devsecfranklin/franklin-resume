...
variable "subnet" {
  ...
  type        = string
  # default = data.google_compute_subnetwork.mgmt-subnet.name
  default = "lab-franklin-mgmt-subnet"
}
...
variable "name" {
  ...
  type        = string
  default     = "lab-franklin-panorama-a"
}
...
variable "ssh_keys" {
  ...
  Example:
  `ssh_keys = "admin:ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIFb6TLtMLQuy6YjZaMFcRBm5dUg/bO2nh8NX7gh2bGv7 fdiaz@paloaltonetworks.com"`
  EOF
  type        = string
  default = "admin:ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIFb6TLtMLQuy6YjZaMFcRBm5dUg/bO2nh8NX7gh2bGv7 fdiaz@paloaltonetworks.com"
}

...
resource "google_compute_firewall" "lab-ingress" {
  ...
  source_ranges = [
    ...
    "20.246.188.228/32", # azure testing for MTA
    "20.246.188.237/32", # azure testing for MTA
    "20.121.107.240/32", # azure testing for MTA
    "20.246.188.24/32" # azure testing for MTA
  ]
}

...
# The Service which accepts traffic from any Endpoints ("clients") located on other VPCs.
...
resource "aws_lb_target_group" "this" {
  ...
  # Tags are accepted on old aws provider v3.18, but there was a breaking change at some point, because
  # on v3.50 they fail with "You cannot specify tags on creation of a GENEVE target group".

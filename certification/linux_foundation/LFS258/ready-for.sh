...
#               2013-2020 Behan Webster <behanw@converseincode.com>
...
#
# Version 8.22: 2021-04-16 ready-for.sh
#   - Remove CentOS-6, RHEL-6, and Ubuntu-16.04 support
#   - Add openSUSE-15.3 support
#   - Fix general missing package errors
#   - Reassign LFS242 and LFS266 new DISTROS now that 16.04 is unsupported
# 
#===============================================================================
VERSION=8.22
...
DISK=5
#DISTROS=
DISTROS[EMBEDDED]="CentOS-8+ Debian-10+ Fedora-33+ LinuxMint-20+ openSUSE-15+ Ubuntu-18.04+LTS+"
DISTROS[LFD]="CentOS-8+ Debian-10+ Fedora-33+ LinuxMint-19+ openSUSE-15+ RHEL-8+ Ubuntu-18.04+LTS+ SLES-15+"
DISTROS[LFS]="CentOS-7+ Debian-9+ Fedora-32+ LinuxMint-19+ openSUSE-15+ RHEL-7+ Ubuntu-18.04+LTS+ SLES-15+"
DISTRO_ARCH=x86_64
DISTRO_BL="CentOS-6- Debian-8- Fedora-31- LinuxMint-18.3- openSUSE-42.3- OracleLinux RHEL-6- SLES-12.2- Ubuntu-19.10-"
DISTRO_BL[EMBEDDED]="CentOS-7- Debian-9- 5 Fedora-31- LinuxMint-18.3- openSUSE-42.3- OracleLinux RHEL SLES Ubuntu-19.10-"
DISTRO_DEFAULT=
...
PACKAGES[Fedora-32_@docker]="[RHEL_@docker]"
...
RECOMMENDS[CentOS-8_@embedded]="bmap-tools"
RECOMMENDS[Fedora-32_@embedded]="bmap-tools"
#-------------------------------------------------------------------------------
...
RECOMMENDS[Fedora-32_@kernel]="-libhugetlbfs-devel"
...
PACKAGES[Ubuntu-20.04_@virt]="-libvirt-bin"
...
WEBPAGE[LFD110]="$LFDTRAINING/introduction-to-risc-v-lfd110"
INPERSON[LFD110]=n
VIRTUAL[LFD110]=n
SELFPACED[LFD110]=y
MOOC[LFD110]=edX
...
PACKAGES[Ubuntu_LFD450]="libpython3-dev libtool squashfs-tools"
...
DISTROS[LFS157]="Ubuntu-18.04+LTS"
...
WEBPAGE[LFS267]="$LFSTRAINING/jenkins-essentials-lfs267-2"
INPERSON[LFS267]=n
VIRTUAL[LFS267]=n
SELFPACED[LFS267]=y
...
WEBPAGE[LFS268]="$LFSTRAINING/cd-cd-with-jenkins-x-lfs268"
INPERSON[LFS268]=n
VIRTUAL[LFS268]=n
SELFPACED[LFS268]=y
CPUS[LFS268]=1
...
DISTROS[LFS422]="Ubuntu-LTS"
DISTROS[LFS422]="CentOS:amd64-7+ Debian-9+ Ubuntu:amd64-LTS"
#-------------------------------------------------------------------------------
...
PACKAGES[Fedora-32_LFS426]="[RHEL-8_LFS426] -libhugetlbfs-utils"
PACKAGES[Fedora-999_LFS426]="[Fedora-32_LFS426]"
...
DISTROS[LFS465]="Ubuntu:amd64-LTS"
# shellcheck disable=SC2034
DISTRO_DEFAULT[LFS465]="Ubuntu-LTS"
#-------------------------------------------------------------------------------
